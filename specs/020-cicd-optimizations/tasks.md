...
**Input**: Design documents from `/specs/020-cicd-optimizations/`
...
- [x] T007 [P] [US2] Add push to `main` branch trigger and `actions/cache` for ESLint to `.github/workflows/lint.yml`
